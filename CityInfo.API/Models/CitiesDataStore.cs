...
public class CitiesDataStore
{
    ...
    public CitiesDataStore()
    {
        Cities = [
            ...
            Landmarks = [
                new LandmarkDto { Id = 1, Name="National Arts Theatre, Iganmu", Description ="A monument for celebrating arts and culture"},
                new LandmarkDto { Id = 2, Name="Freedom Park", Description ="A historical site"}
                ]},

            new CityDto{Id= 3, Name="Ogun",Slogan = "Gateway State" ,
            Landmarks = [
                new LandmarkDto { Id = 1, Name="Olumo Rock", Description ="A place of refuge for ancient Egba people."}
                ]},
